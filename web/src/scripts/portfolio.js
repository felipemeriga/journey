...
(() => {
  ...
  const projects = [
    { kicker: 'Rust · crates.io', meta: '★ 75', title: 'socket-flow', body: 'An async WebSocket library I wrote from scratch on Tokio: full RFC 6455, TLS, and compression, no wrapping of an existing crate. It passes the Autobahn conformance suite as both client and server.', stack: 'Rust · Tokio · tokio-rustls · flate2', href: 'https://github.com/felipemeriga/socket-flow', cta: 'View on GitHub →' },
