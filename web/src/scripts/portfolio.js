...
(() => {
  ...
  const projects = [
    { kicker: 'Rust · crates.io', meta: '★ 75', title: 'socket-flow', body: 'An async WebSocket library I wrote from scratch on Tokio: full RFC 6455, TLS, and compression, no wrapping of an existing crate. It passes the Autobahn conformance suite as both client and server, which most hand-rolled ones never manage.', stack: 'Rust · Tokio · tokio-rustls · flate2', href: 'https://github.com/felipemeriga/socket-flow', cta: 'View on GitHub →' },
    { kicker: 'Rust · P2P', meta: '★ 18', title: 'Artemis Network', body: 'A working blockchain node, built from the bytes up. Proof-of-work mining, real ECDSA signatures, longest-chain consensus, and peers that find each other and gossip blocks. Five concurrent Tokio tasks, one shared chain.', stack: 'Rust · Tokio · secp256k1 · Sled', href: 'https://github.com/felipemeriga/artemis-network', cta: 'View on GitHub →' },
    { kicker: 'AI · MCP', meta: 'OSS', title: 'Kioku (記憶)', body: 'A memory layer for coding agents that I run myself. It plugs into Claude Code, so a session starts with the repo already loaded in context and ends with what I learned saved back for next time. Agentic RAG underneath, with an eval harness to keep retrieval honest.', stack: 'Python · FastAPI · pgvector · TypeScript · Claude', href: 'https://github.com/felipemeriga/kioku', cta: 'View on GitHub →' },
    { kicker: 'AI · product', meta: 'Live', title: 'RoleMiner', body: 'An AI job hunter that learns from what you do, not a preferences form. It watches which roles you save and skip, remembers it, and gets sharper about what it shows you next. An 18-tool agent loop, with ~876 tests keeping it honest.', stack: 'Python · FastAPI · React 19 · Supabase · Anthropic · Mem0', href: 'https://roleminer.app/', cta: 'Open roleminer.app →' },
  ];
